...
abstract class $AppThemeCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, bool dflt, AppColors colors, AppAssets assetsImg});
...
class __$$_AppThemeCopyWithImpl<$Res>
  ...
  __$$_AppThemeCopyWithImpl(
    _$_AppTheme _value,
    $Res Function(_$_AppTheme) _then,
  ) : super(_value, _then);
...
class _$_AppTheme with DiagnosticableTreeMixin implements _AppTheme {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AppTheme(name: $name, dflt: $dflt, colors: $colors, assetsImg: $assetsImg)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, dflt, colors, assetsImg);
...
abstract class _AppTheme implements AppTheme {
  const factory _AppTheme({
    ...
    required final AppAssets assetsImg,
  }) = _$_AppTheme;
