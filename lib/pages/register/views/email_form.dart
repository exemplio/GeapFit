                                  ...
                                  children: [
                                    ...
                                    !principal
                                        ? SizedBox(
                                          ...
                                          child: TextFormField(
                                            enabled: questions.isNotEmpty,
                                            controller: emailToSendController,
                                            keyboardType:
  ...
  Widget _buttonSend() {
    ...
    return Expanded(
      child: TextButton.icon(
        ...
        label: Text(
          titleButton,
          style: const TitleTextStyle(color: ColorUtil.white, fontSize: 12),
        ),
      ),
    );
  }
          ...
          showDialog(
            ...
            builder:
                (BuildContext context) => PopScope(
                  canPop: false,
                  child: Alerts.error(
                    sendRecover.errorMessage ?? "Error",
                    () => Navigator.pop(context),
                  ),
                ),
          );
