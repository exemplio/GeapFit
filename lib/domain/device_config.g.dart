...
DeviceConfig _$DeviceConfigFromJson(Map<String, dynamic> json) => DeviceConfig(
  ...
  tmsPort: (json['tms_port'] as num?)?.toInt(),
  functionalityIncluded: json['functionality_included'] as bool?,
  connectionRetries: (json['connection_retries'] as num?)?.toInt(),
  ...
  lotClosureDays: (json['lot_closure_days'] as num?)?.toInt(),
  ...
  inactivityTime: (json['inactivity_time'] as num?)?.toInt(),
  affiliationType: json['affiliation_type'] as String?,
  dataEntry: json['data_entry'] as String?,
  coin: json['coin'] as String?,
  percentageTip: (json['percentage_tip'] as num?)?.toInt(),
  readingTypes:
      (json['reading_types'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList(),
  sendOnlyDefaultConnection: json['send_only_default_connection'] as bool?,
  forcedCloseTime: (json['forced_close_time'] as num?)?.toInt(),
  forcedCloseTimeUnit: json['forced_close_time_unit'] as String?,
);

Map<String, dynamic> _$DeviceConfigToJson(
  ...
  'request_cash_advancement_password': instance.requestCashAdvancementPassword,
